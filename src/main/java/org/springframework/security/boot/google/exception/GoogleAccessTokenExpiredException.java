...
public class GoogleAccessTokenExpiredException extends AuthenticationTokenExpiredException {
	...
	/**
	 * Constructs an <code>GoogleAccessTokenExpiredException</code> with the
	 * specified message.
	 *
	 * @param msg the detail message
	 */
	public GoogleAccessTokenExpiredException(String msg) {
		super(msg);
	}
	 ...
	 * @param t root cause
	 */
	public GoogleAccessTokenExpiredException(String msg, Throwable t) {
		super(msg, t);
	}
